    ...
    lessons: [
      {
        code: 'Ft1',
        dir: 'Ft1-zoeken',
        printName: 'SeniorEase-Ft1-Zoeken-v2.pdf',
        beamerName: 'SeniorEase-Ft1-Beamer-v2.pdf',
      },
      {
        code: 'Ft2',
        dir: 'Ft2-browser',
        printName: 'SeniorEase-Ft2-Browser-v2.pdf',
        beamerName: 'SeniorEase-Ft2-Beamer-v2.pdf',
      },
      {
        code: 'Ft3',
        dir: 'Ft3-qr-codes',
        printName: 'SeniorEase-Ft3-QR-v2.pdf',
        beamerName: 'SeniorEase-Ft3-Beamer-v2.pdf',
      },
      {
        code: 'Ft4',
        dir: 'Ft4-formulieren-downloads',
        printName: 'SeniorEase-Ft4-Formulieren-Downloads-v2.pdf',
        beamerName: 'SeniorEase-Ft4-Beamer-v2.pdf',
      },
    ],
  },
  'pakket-f-computer': {
    ...
    lessons: [
      {
        ...
        printName: 'SeniorEase-Fc1-Zoeken-Google-v2.pdf',
        beamerName: 'SeniorEase-Fc1-Beamer-v2.pdf',
      },
      {
        code: 'Fc2',
        dir: 'Fc2-websites-tabbladen',
        printName: 'SeniorEase-Fc2-Websites-Tabbladen-v2.pdf',
        beamerName: 'SeniorEase-Fc2-Beamer-v2.pdf',
      },
      {
        code: 'Fc3',
        dir: 'Fc3-downloaden',
        printName: 'SeniorEase-Fc3-Veilig-Downloaden-v2.pdf',
        beamerName: 'SeniorEase-Fc3-Beamer-v2.pdf',
      },
      {
        code: 'Fc4',
        dir: 'Fc4-formulieren',
        printName: 'SeniorEase-Fc4-Formulieren-v2.pdf',
        beamerName: 'SeniorEase-Fc4-Beamer-v2.pdf',
      },
    ],
  },
  'pakket-g': {
