...
export const SITE_SEARCH_INDEX: SiteSearchItem[] = [
  ...
  { href: '/uitleg/fotos-ordenen', title: "Foto's ordenen en bewaren", description: "Foto's sorteren, back-up en overzicht houden.", category: 'Uitleg', keywords: ['foto', 'album', 'galerij', 'back-up', 'opslaan'] },
