#!/usr/bin/env python3
"""Render H3 print + beamer for visual QA."""
...
print_pdf = root / "pdf" / "SeniorEase-H3-Betere-vragen-stellen-aan-AI-v2.pdf"
beamer_pdf = root / "beamer" / "SeniorEase-H3-Beamer-v2.pdf"
