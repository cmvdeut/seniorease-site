#!/usr/bin/env python3
"""Render H4 print + beamer for visual QA."""
...
print_pdf = root / "pdf" / "SeniorEase-H4-AI-antwoorden-controleren-en-veilig-gebruiken-v2.pdf"
beamer_pdf = root / "beamer" / "SeniorEase-H4-Beamer-v2.pdf"
