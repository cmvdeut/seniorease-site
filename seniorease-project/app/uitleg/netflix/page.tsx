      ...
      <div className="max-w-senior mx-auto px-5 sm:px-6 py-12">
        <div className="max-w-4xl mx-auto space-y-10">
          ...
          <section className="bg-slate rounded-senior border border-navy/8 p-8 md:p-10">
            ...
            <div className="space-y-6">
              <div className="bg-paper border border-navy/8 rounded-xl p-6">
                <h3 className="text-senior-base font-bold text-navy mb-3">📱 Op Android (Samsung, Motorola, etc.)</h3>
          ...
          <section className="bg-slate rounded-senior border border-navy/8 p-8 md:p-10">
            ...
            <div className="space-y-4">
              <div className="flex gap-4 items-start">
                <div className="flex-shrink-0 w-10 h-10 bg-gold text-white rounded-full flex items-center justify-center font-bold text-senior-base">A</div>
                <div>
                  <p className="text-senior-base font-bold text-navy">Heeft u al een account?</p>
                  <p className="text-senior-base text-navy/80">Tik op <strong>Aanmelden</strong>. Vul uw e-mailadres en wachtwoord in en tik op <strong>Aanmelden</strong>.</p>
                </div>
              </div>
              <div className="flex gap-4 items-start">
                <div className="flex-shrink-0 w-10 h-10 bg-gold text-white rounded-full flex items-center justify-center font-bold text-senior-base">B</div>
                <div>
                  <p className="text-senior-base font-bold text-navy">Nog geen account?</p>
                  <p className="text-senior-base text-navy/80">Tik op <strong>Aan de slag</strong>. Vul uw e-mailadres in, kies een wachtwoord en kies een abonnement. U kunt betalen met creditcard of iDEAL.</p>
                </div>
              </div>
            </div>
            <div className="mt-6 p-4 rounded-xl bg-paper border border-navy/10">
              <p className="text-senior-base font-bold text-navy">Tip</p>
              <p className="text-senior-base text-navy/80 mt-1">Schrijf uw e-mailadres en wachtwoord op een papiertje en bewaar dit op een veilige plek. U heeft het nodig als u Netflix op een ander apparaat wilt gebruiken.</p>
            </div>
          </section>
          ...
          <section className="bg-paper border border-navy/10 rounded-2xl p-8 md:p-10">
            ...
            <div className="space-y-6">
              <div>
                <p className="text-senior-base font-bold text-navy mb-1">Kost Netflix geld?</p>
                <p className="text-senior-base text-navy/80">Ja, Netflix is een betaald abonnement. U betaalt maandelijks, momenteel vanaf ongeveer €5 per maand. U kunt op elk moment opzeggen.</p>
              </div>
              <div>
                <p className="text-senior-base font-bold text-navy mb-1">Kan ik Netflix op mijn televisie kijken?</p>
                <p className="text-senior-base text-navy/80">Ja. Als uw televisie een &quot;Smart TV&quot; is, staat de Netflix-app er vaak al op. Zoek op uw afstandsbediening naar een Netflix-knop of open de app via het beginscherm van uw tv.</p>
              </div>
              <div>
                <p className="text-senior-base font-bold text-navy mb-1">Hoe zeg ik Netflix op?</p>
                <p className="text-senior-base text-navy/80">Ga naar de Netflix-website op uw computer. Log in, klik rechtsboven op uw naam, ga naar &quot;Account&quot; en kies &quot;Abonnement annuleren&quot;. U kunt tot aan het einde van de betaalperiode blijven kijken.</p>
              </div>
            </div>
          </section>
