      ...
      <section className="container mx-auto px-6 py-10">
        <div className="max-w-4xl mx-auto space-y-10">
          ...
          <div className="bg-white rounded-2xl shadow-xl border-4 border-neutral-stone p-8 md:p-10">
            ...
            <h3 className="text-senior-lg font-bold text-gray-800 mt-4">Spraakbericht opnemen</h3>
            ...
            <h3 className="text-senior-lg font-bold text-gray-800 mt-6">Spraakbericht afspelen</h3>
            <ol className="list-decimal list-outside pl-6 space-y-2 text-senior-base text-gray-800 leading-relaxed">
          ...
          <div className="bg-white rounded-2xl shadow-xl border-4 border-neutral-stone p-8 md:p-10">
            ...
            <h3 className="text-senior-lg font-bold text-gray-800 mt-4">Status bekijken</h3>
            <ol className="list-decimal list-outside pl-6 space-y-2 text-senior-base text-gray-800 leading-relaxed">
            ...
            <h3 className="text-senior-lg font-bold text-gray-800 mt-6">Eigen status plaatsen</h3>
            <ol className="list-decimal list-outside pl-6 space-y-2 text-senior-base text-gray-800 leading-relaxed">
          ...
          <div className="bg-white rounded-2xl shadow-xl border-4 border-neutral-stone p-8 md:p-10">
            ...
            <h3 className="text-senior-lg font-bold text-gray-800 mt-4">Groep aanmaken</h3>
            <ol className="list-decimal list-outside pl-6 space-y-2 text-senior-base text-gray-800 leading-relaxed">
            ...
            <h3 className="text-senior-lg font-bold text-gray-800 mt-6">Iemand toevoegen aan een bestaande groep</h3>
            <ol className="list-decimal list-outside pl-6 space-y-2 text-senior-base text-gray-800 leading-relaxed">
            ...
            <h3 className="text-senior-lg font-bold text-gray-800 mt-6">In een groep chatten</h3>
            <ol className="list-decimal list-outside pl-6 space-y-2 text-senior-base text-gray-800 leading-relaxed">
