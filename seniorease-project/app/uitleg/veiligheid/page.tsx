...
export default function VeiligheidPage() {
  return (
    <main className="min-h-screen bg-cream">
      ...
      <YoutubeVideoJsonLd videoKey="oplichtingHerkennen" />
      {/* Header */}
        ...
        <div className="max-w-senior mx-auto px-5 sm:px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <nav className="mt-6 flex flex-wrap gap-3" aria-label="Veiligheid navigatie">
              ...
              <span className="text-senior-sm font-bold text-gold underline">Oplichting herkennen</span>
              <Link href="/uitleg/wachtwoorden" className="text-senior-sm font-bold text-gold hover:text-gold-light hover:underline">Wachtwoorden</Link>
            </nav>
          </div>
        </div>
      </header>
        ...
        <div className="max-w-4xl mx-auto space-y-10">
          ...
          <section className="my-8 mx-4 sm:mx-0">
            ...
            <div className="max-w-3xl mx-auto mt-6 rounded-2xl p-6 flex flex-col sm:flex-row items-start sm:items-center gap-4 border border-navy/10/40 bg-white">
              ...
              <div>
                <h3 className="text-senior-lg font-bold text-navy mb-1">Meer tips op YouTube</h3>
          ...
          <section className="bg-slate rounded-senior border border-navy/8 p-8 md:p-10">
            ...
            <p className="text-senior-sm md:text-senior-base text-navy/80 leading-relaxed mb-6">
              Ze worden steeds beter in nabootsen. Berichten zien er soms precies uit als echt. Maar er zijn altijd signalen die u kunt leren herkennen. Een korte samenvatting vindt u ook in <Link href="/digitale-hulp/phishing-herkennen" className="font-semibold text-gold hover:text-gold-light">Phishing herkennen</Link>.
            </p>
            <div className="grid sm:grid-cols-3 gap-4">
              {[
                ...
                <div key={i} className="bg-cream border-2 border-navy/8/30 rounded-xl p-4 text-center">
                  ...
                  <p className="text-senior-sm font-bold text-navy">{item.tekst}</p>
                </div>
              ))}
            </div>
          </section>
          ...
          <section className="bg-slate rounded-senior border border-navy/8 p-8 md:p-10">
            ...
            <div className="bg-gray-100 rounded-2xl p-6 mb-6 max-w-sm">
              <div className="flex items-center gap-2 mb-3">
                <div className="w-8 h-8 bg-paper0 rounded-full flex items-center justify-center text-white text-sm font-bold">ING</div>
                <span className="text-senior-sm font-bold text-navy/80">ING Bank</span>
            ...
            <div className="space-y-3">
              <p className="text-senior-base font-bold text-navy mb-3">Wat klopt er niet?</p>
              {[
                ...
                <div key={i} className="flex items-start gap-3 bg-red-50 border-2 border-red-200 rounded-xl p-4">
                  ...
                  <div>
                    ...
                    <p className="text-senior-base text-navy/80">{item.uitleg}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <section className="bg-slate rounded-senior border border-navy/8 p-8 md:p-10">
            ...
            <div className="bg-gray-100 rounded-2xl p-6 mb-6 max-w-sm">
              <div className="flex items-center gap-2 mb-4">
                ...
                <div>
                  <p className="text-senior-sm font-bold text-navy/80">Onbekend nummer</p>
              ...
              <div className="space-y-2">
                <div className="bg-green-100 rounded-2xl rounded-tl-sm p-3 max-w-xs">
                  <p className="text-senior-base text-navy">Hoi mam! Dit is mijn nieuwe nummer. Mijn oude telefoon is kapot gegaan 😢</p>
                </div>
                <div className="bg-green-100 rounded-2xl rounded-tl-sm p-3 max-w-xs">
                  <p className="text-senior-base text-navy">Kun je me helpen? Ik moet dringend €250 betalen maar kan zelf niet bij mijn bankrekening.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-green-50 border-2 border-green-200 rounded-xl p-5">
              ...
              <p className="text-senior-base text-navy/80 leading-relaxed">
                Niet reageren, niet betalen. Bel uw kind of kleinkind op het <strong>oude, bekende nummer</strong> om te controleren of het echt van hen is. Meer over veilig WhatsApp gebruiken: <Link href="/uitleg/whatsapp-basis" className="font-semibold text-gold hover:text-gold-light">WhatsApp uitleg</Link>.
              </p>
            </div>
          </section>
          ...
          {/* 5 alarmsignalen */}
          <section>
            <h2 className="text-senior-xl font-bold text-navy mb-2">
              De 5 alarmsignalen
            </h2>
            <p className="text-senior-base text-navy/70 mb-6">
              ...
              {alarmsignalen.map((signaal) => (
                <div key={signaal.num} className={`rounded-2xl border-2 ${signaal.kleur} p-6 flex gap-5 items-start`}>
                  ...
                  <div>
                    ...
                    <p className="text-senior-base text-navy/80 leading-relaxed">{signaal.uitleg}</p>
                  </div>
                </div>
              ))}
            </div>
              ...
              {[
                ...
                <li key={i} className="flex gap-5 items-start">
                  ...
                  <div className="flex gap-3 items-start pt-2">
                    ...
                    <p className="text-senior-sm md:text-senior-base text-navy/80 leading-relaxed">{item.stap}</p>
                  </div>
                </li>
              ))}
            </ol>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {[
                ...
                <div key={i} className="bg-cream border-2 border-navy/10 rounded-xl p-5">
                  ...
                  <p className="text-senior-lg font-bold text-gold my-1">{item.num}</p>
                  <p className="text-senior-xs text-navy/70">{item.omschr}</p>
                </div>
              ))}
            </div>
          ...
          <section className="bg-slate rounded-senior border border-navy/8 p-8 md:p-10">
            ...
            <ul className="space-y-2 mb-6">
              <li>
                <Link href="/uitleg/digid" className="text-senior-base font-semibold text-gold hover:text-gold-light underline">
                  DigiD veilig gebruiken
                </Link>
              </li>
              <li>
                <Link href="/uitleg/online-bankieren" className="text-senior-base font-semibold text-gold hover:text-gold-light underline">
                  Veilig online bankieren
                </Link>
              </li>
              <li>
                <Link href="/digitale-hulp/veilig-internet" className="text-senior-base font-semibold text-gold hover:text-gold-light underline">
                  Veilig internet (alle artikelen)
                </Link>
              </li>
              <li>
                <Link href="/digitale-hulp/phishing-mail-herkennen" className="text-senior-base font-semibold text-gold hover:text-gold-light underline">
                  Phishing mail herkennen
                </Link>
              </li>
              <li>
                <Link href="/digitale-hulp/veilig-wachtwoord-maken" className="text-senior-base font-semibold text-gold hover:text-gold-light underline">
            ...
            <div className="flex flex-wrap gap-4">
              <Link href="/uitleg/wachtwoorden" className="inline-flex items-center gap-2 bg-gold text-white px-7 py-4 rounded-xl text-senior-lg font-bold hover:bg-gold-light transition-colors ">
                Volgende: Wachtwoorden →
              </Link>
              <Link href="/" className="inline-flex items-center gap-2 bg-white border-2 border-navy/8 text-gold px-7 py-4 rounded-xl text-senior-lg font-bold hover:bg-gold/10 transition-colors">
                ← Terug naar home
              </Link>
            </div>
          </section>
