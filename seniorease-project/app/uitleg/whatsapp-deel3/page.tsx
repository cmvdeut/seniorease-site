      ...
      <section className="container mx-auto px-6 py-10">
        <div className="max-w-4xl mx-auto space-y-10">
          ...
          <div className="bg-white rounded-2xl shadow-xl border-4 border-neutral-stone p-8 md:p-10">
            ...
            <h3 className="text-senior-lg font-bold text-gray-800 mt-4">Bericht doorsturen</h3>
            <ol className="list-decimal list-outside pl-6 space-y-2 text-senior-base text-gray-800 leading-relaxed">
            ...
            <h3 className="text-senior-lg font-bold text-gray-800 mt-6">Bericht verwijderen</h3>
            <ol className="list-decimal list-outside pl-6 space-y-2 text-senior-base text-gray-800 leading-relaxed">
            ...
            <h3 className="text-senior-lg font-bold text-gray-800 mt-6">Bericht beantwoorden</h3>
            <ol className="list-decimal list-outside pl-6 space-y-2 text-senior-base text-gray-800 leading-relaxed">
          ...
          <div className="bg-white rounded-2xl shadow-xl border-4 border-neutral-stone p-8 md:p-10">
            ...
            <h3 className="text-senior-lg font-bold text-gray-800 mt-4">Gesprek pinnen</h3>
            <ol className="list-decimal list-outside pl-6 space-y-2 text-senior-base text-gray-800 leading-relaxed">
            ...
            <h3 className="text-senior-lg font-bold text-gray-800 mt-6">Gesprek archiveren (opbergen)</h3>
            <ol className="list-decimal list-outside pl-6 space-y-2 text-senior-base text-gray-800 leading-relaxed">
            ...
            <h3 className="text-senior-lg font-bold text-gray-800 mt-6">Zoeken in gesprekken</h3>
            <ol className="list-decimal list-outside pl-6 space-y-2 text-senior-base text-gray-800 leading-relaxed">
          ...
          <div className="bg-white rounded-2xl shadow-xl border-4 border-neutral-stone p-8 md:p-10">
            ...
            <h3 className="text-senior-lg font-bold text-gray-800 mt-4">Groep dempen (mute)</h3>
            <ol className="list-decimal list-outside pl-6 space-y-2 text-senior-base text-gray-800 leading-relaxed">
            ...
            <h3 className="text-senior-lg font-bold text-gray-800 mt-6">Beheerder van de groep</h3>
            <ol className="list-decimal list-outside pl-6 space-y-2 text-senior-base text-gray-800 leading-relaxed">
            ...
            <h3 className="text-senior-lg font-bold text-gray-800 mt-6">Groep verlaten</h3>
            <ol className="list-decimal list-outside pl-6 space-y-2 text-senior-base text-gray-800 leading-relaxed">
          ...
          <div className="bg-white rounded-2xl shadow-xl border-4 border-neutral-stone p-8 md:p-10">
            ...
            <h3 className="text-senior-lg font-bold text-gray-800 mt-4">Waar vindt u de instellingen?</h3>
            ...
            <h3 className="text-senior-lg font-bold text-gray-800 mt-6">Privacy-opties</h3>
            <p className="text-senior-base text-gray-800 leading-relaxed">
              Ga naar <strong>Instellingen → Account → Privacy</strong>. Daar kunt u bepalen wat anderen van u zien.
            </p>
            <ol className="list-decimal list-outside pl-6 space-y-2 text-senior-base text-gray-800 leading-relaxed mt-4">
          ...
          <div className="bg-white rounded-2xl shadow-xl border-4 border-neutral-stone p-8 md:p-10">
            ...
            <h3 className="text-senior-lg font-bold text-gray-800 mt-6">Automatisch downloaden</h3>
            <ol className="list-decimal list-outside pl-6 space-y-2 text-senior-base text-gray-800 leading-relaxed">
            ...
            <h3 className="text-senior-lg font-bold text-gray-800 mt-6">Back-up maken (reservekopie)</h3>
            <p className="text-senior-base text-gray-800 leading-relaxed mb-2">
          ...
          <div className="bg-white rounded-2xl shadow-xl border-4 border-amber-300 p-8 md:p-10">
            ...
            <ul className="space-y-3 text-senior-base text-gray-800 leading-relaxed list-disc list-outside pl-6">
