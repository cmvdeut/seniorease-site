    ...
    },
    {
      ...
      uitleg: (
        <>
          ...
          <Link href="/digitale-hulp/veilig-wachtwoord-maken" className="font-bold text-primary hover:underline">Veilig wachtwoord maken</Link>.
        </>
      ),
    },
  ];
      ...
      <div className="container mx-auto px-6 py-12">
        <div className="max-w-4xl mx-auto space-y-10">
          ...
          <section className="bg-white rounded-2xl shadow-xl border-4 border-primary p-8 md:p-10">
            <h2 className="text-senior-xl font-bold text-primary mb-4">Wat is DigiD?</h2>
          ...
          <section className="bg-white rounded-2xl shadow-xl border-4 border-primary p-8 md:p-10">
            <h2 className="text-senior-xl font-bold text-primary mb-6">DigiD aanvragen — stap voor stap</h2>
          ...
          <section className="bg-white rounded-2xl shadow-xl border-4 border-neutral-stone p-8 md:p-10">
            <h2 className="text-senior-xl font-bold text-primary mb-6">Inloggen met DigiD</h2>
          ...
          <section className="bg-red-50 border-2 border-red-200 rounded-2xl p-8 md:p-10">
            ...
            <p className="text-senior-sm md:text-senior-base text-gray-700 mt-4">
              Meer alarmsignalen:{' '}
              <Link href="/uitleg/veiligheid" className="font-bold text-primary hover:underline">Oplichting herkennen</Link> en{' '}
              <Link href="/digitale-hulp/phishing-mail-herkennen" className="font-bold text-primary hover:underline">Phishing mail herkennen</Link>.
            </p>
          </section>
          ...
          <section className="bg-white rounded-2xl shadow-xl border-4 border-neutral-stone p-8">
            ...
            <ul className="space-y-3">
              <li><Link href="/uitleg/online-bankieren" className="text-senior-base font-bold text-primary hover:underline">Veilig online bankieren →</Link></li>
              <li><Link href="/uitleg/wachtwoorden" className="text-senior-base font-bold text-primary hover:underline">Wachtwoorden beheren →</Link></li>
              <li><Link href="/digitale-hulp/apps-installeren" className="text-senior-base font-bold text-primary hover:underline">DigiD app installeren (telefoon) →</Link></li>
            </ul>
          </section>
