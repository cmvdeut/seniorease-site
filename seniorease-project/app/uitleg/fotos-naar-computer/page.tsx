        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <nav className="mt-6 flex flex-wrap gap-3" aria-label="Foto uitleg navigatie">
              <span className="text-senior-sm text-gray-500 font-semibold mr-1">📷 Foto&apos;s:</span>
              <Link href="/uitleg/fotos-maken" className="text-senior-sm font-bold text-primary hover:text-primary-dark hover:underline">
                Foto&apos;s maken
              </Link>
              <Link href="/uitleg/fotos-ordenen" className="text-senior-sm font-bold text-primary hover:text-primary-dark hover:underline">
                Foto&apos;s ordenen
              </Link>
              <span className="text-senior-sm font-bold text-primary underline">Naar computer</span>
            </nav>
          </div>
        </div>
      </header>
      ...
      <div className="container mx-auto px-6 py-12">
        <div className="max-w-4xl mx-auto space-y-10">
          ...
          <section className="bg-white rounded-2xl shadow-xl border-4 border-primary p-8 md:p-10">
            <h2 className="text-senior-xl font-bold text-primary mb-4">Waarom naar de computer?</h2>
          ...
          <section className="bg-white rounded-2xl shadow-xl border-4 border-primary p-8 md:p-10">
            ...
            <p className="text-senior-sm text-gray-600 mb-6">
          ...
          <section className="bg-white rounded-2xl shadow-xl border-4 border-neutral-stone p-8 md:p-10">
            <h2 className="text-senior-xl font-bold text-primary mb-2">Methode 2 — Via WhatsApp</h2>
            <p className="text-senior-sm text-gray-600 mb-6">
              Handig als u WhatsApp al gebruikt. Meer over foto&apos;s in WhatsApp:{' '}
              <Link href="/digitale-hulp/whatsapp-fotos-opslaan" className="font-bold text-primary hover:underline">
          ...
          <section className="bg-white rounded-2xl shadow-xl border-4 border-neutral-stone p-8 md:p-10">
            <h2 className="text-senior-xl font-bold text-primary mb-6">Methode 3 — Met een USB-kabel</h2>
            <div className="space-y-10">
              ...
              <div className="border-t border-neutral-stone/50 pt-8">
                <h3 className="text-senior-lg font-bold text-blue-800 mb-4">🍎 iPhone + computer</h3>
          ...
          <section className="bg-white rounded-2xl shadow-xl border-4 border-primary p-8 md:p-10">
            ...
            <p className="text-senior-sm md:text-senior-base text-gray-700 leading-relaxed mb-6">
              ...
              <Link href="/digitale-hulp/wat-is-de-cloud" className="font-bold text-primary hover:underline">
                Wat is de cloud?
              </Link>
              .
            </p>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-green-50 border-2 border-green-200 rounded-xl p-6">
                ...
                <ol className="space-y-3 list-decimal list-outside pl-5 text-senior-base text-gray-700">
              ...
              <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-6">
                <h3 className="text-senior-lg font-bold text-blue-800 mb-3">🍎 iCloud</h3>
                <ol className="space-y-3 list-decimal list-outside pl-5 text-senior-base text-gray-700">
            ...
            <p className="text-senior-sm text-gray-600 mt-4">
              ...
              <Link href="/uitleg/fotos-ordenen" className="font-bold text-primary hover:underline">
                Foto&apos;s ordenen
              </Link>{' '}
          ...
          <section className="bg-amber-50 border-2 border-amber-200 rounded-2xl p-8 md:p-10">
            ...
            <div className="space-y-6">
              <div>
                <p className="text-senior-base font-bold text-gray-800 mb-1">Welke methode is het makkelijkst?</p>
              ...
              <div>
                <p className="text-senior-base font-bold text-gray-800 mb-1">Kan ik meerdere foto&apos;s tegelijk overzetten?</p>
                <p className="text-senior-base text-gray-700">
              ...
              <div>
                <p className="text-senior-base font-bold text-gray-800 mb-1">Verdwijnen de foto&apos;s op mijn telefoon?</p>
                <p className="text-senior-base text-gray-700">
              ...
              <div>
                <p className="text-senior-base font-bold text-gray-800 mb-1">Ik kom er niet uit — wat nu?</p>
                <p className="text-senior-base text-gray-700">
          ...
          <section className="bg-white rounded-2xl shadow-xl border-4 border-neutral-stone p-8">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/uitleg/fotos-maken" className="text-senior-base font-bold text-primary hover:underline">
                  Betere foto&apos;s maken →
                </Link>
              </li>
              <li>
                <Link href="/digitale-hulp/whatsapp-fotos-opslaan" className="text-senior-base font-bold text-primary hover:underline">
                  WhatsApp foto&apos;s opslaan →
                </Link>
              </li>
              <li>
                <Link href="/uitleg/wifi" className="text-senior-base font-bold text-primary hover:underline">
                  WiFi instellen →
                </Link>
              </li>
            </ul>
