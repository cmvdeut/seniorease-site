export default function KalenderAnimatiePage() {
  return (
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h1 className="text-senior-2xl md:text-senior-3xl font-bold text-primary">
                  Verjaardagskalender Animatie
                </h1>
                <p className="text-senior-base text-gray-600 mt-2">
                  Leer stap-voor-stap hoe u verjaardagen toevoegt aan uw kalender
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="bg-yellow-50 border-4 border-yellow-400 rounded-xl p-6 mb-6">
            <p className="text-senior-base text-gray-700">
              ...
              De animatie toont automatisch hoe u een verjaardag toevoegt door op een datum te klikken.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-6 pb-12">
        <div className="max-w-6xl mx-auto">
          <div className="bg-white rounded-xl shadow-lg border-4 border-primary overflow-hidden">
            <iframe
              src="/youtube-animaties/kalender-animatie.html"
              className="w-full"
              style={{ height: 'calc(100vh - 300px)', minHeight: '600px', border: 'none' }}
              title="Verjaardagskalender Animatie"
              key="kalender-animatie-static"
            />
          </div>
        </div>
      </div>
