...
const Intro = ({ title }) => {
  ...
  const logoScale = (0,esm.spring)({ frame, fps, config: { damping: 14, mass: 0.8 } });
  const titleOpacity = (0,esm.interpolate)(frame, [25, 45], [0, 1], { extrapolateRight: "clamp" });
  const titleY = (0,esm.interpolate)(frame, [25, 45], [30, 0], { extrapolateRight: "clamp" });
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    esm.AbsoluteFill,
    {
      ...
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { transform: `scale(${logoScale})` }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Img, { src: (0,esm.staticFile)("heart-logo.png"), style: { width: 200, height: 200 } }) }),
...
const Outro = () => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  const scale = (0,esm.spring)({ frame, fps, config: { damping: 14, mass: 0.8 }, from: 0.85, to: 1 });
  const opacity = (0,esm.interpolate)(frame, [0, 20], [0, 1], { extrapolateRight: "clamp" });
  const buttonOpacity = (0,esm.interpolate)(frame, [30, 50], [0, 1], { extrapolateRight: "clamp" });
    ...
    esm.AbsoluteFill,
    {
      ...
      children: /* @__PURE__ */ (0,jsx_runtime.jsxs)(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Img, { src: (0,esm.staticFile)("heart-logo.png"), style: { width: 160, height: 160 } }),
            /* @__PURE__ */ (0,jsx_runtime.jsx)(
              "div",
              {
                style: {
            ...
            /* @__PURE__ */ (0,jsx_runtime.jsx)(
              "div",
              {
                ...
                children: "Technologie zonder gedoe"
              }
            ),
            /* @__PURE__ */ (0,jsx_runtime.jsxs)(
              "div",
...
;// ./src/components/TapIndicator.tsx



const TAP_ELEMENT_POSITIONS = {
...
const TapIndicator = ({
  ...
  const rippleScale = (0,esm.interpolate)(rippleFrame, [0, RIPPLE_CYCLE * 0.7], [1, 2.8], {
    extrapolateRight: "clamp"
  });
  const rippleOpacity = (0,esm.interpolate)(rippleFrame, [0, RIPPLE_CYCLE * 0.7], [0.7, 0], {
    extrapolateRight: "clamp"
  });
      ...
      children: [
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            ...
            children: /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: 26, lineHeight: 1 }, children: "\u{1F446}" })
          }
        )
      ]
    }
...
const Avatar = ({ initials, size = 40, bg = "#aaa" }) => /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
  width: size,
  height: size,
  borderRadius: "50%",
  backgroundColor: bg,
...
const ChatListScreen = () => /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", height: "100%", position: "relative" }, children: [
  /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: {
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { color: "#fff", fontSize: 20, fontWeight: "bold", fontFamily: "Segoe UI, Arial, sans-serif" }, children: "WhatsApp" }),
    /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", gap: 16, color: "#fff", fontSize: 18 }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { children: "\u{1F50D}" }),
  ...
  /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: {
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontSize: 14, color: "#888" }, children: "\u{1F50D}" }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontSize: 14, color: "#aaa", fontFamily: "Segoe UI, Arial, sans-serif" }, children: "Zoeken..." })
  ] }),
  [
    { init: "M", name: "Mama", msg: "Hoe gaat het?", time: "09:14", bg: "#e91e63" },
    { init: "P", name: "Peter", msg: "Tot morgen \u{1F44D}", time: "Gis", bg: "#2196f3" },
    { init: "F", name: "Fam. Groep", msg: "Gezellig!", time: "Ma", bg: WA_GREEN }
  ].map((c) => /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: {
    display: "flex",
    alignItems: "center",
    gap: 12,
    padding: "10px 16px",
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(Avatar, { initials: c.init, size: 46, bg: c.bg }),
    /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { flex: 1, minWidth: 0 }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", justifyContent: "space-between" }, children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontSize: 15, fontWeight: "bold", fontFamily: "Segoe UI, Arial, sans-serif", color: "#111" }, children: c.name }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontSize: 12, color: "#888", fontFamily: "Segoe UI, Arial, sans-serif" }, children: c.time })
      ] }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontSize: 13, color: "#666", fontFamily: "Segoe UI, Arial, sans-serif" }, children: c.msg })
    ] })
  ] }, c.name)),
  /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { flex: 1, backgroundColor: "#f5f5f5" } }),
...
const DRAFT_MSG = "Dag mama! \u{1F44B}";
const ChatScreen = ({
  showAttachmentMenu,
  tapElement,
  tapDelay = 25
  ...
  const typeProgress = tapElement === "type-field" ? (0,esm.interpolate)(frame, [typingStart, typingStart + 38], [0, 1], { extrapolateRight: "clamp" }) : tapElement === "send-button" ? 1 : 0;
  const visibleLen = Math.floor(typeProgress * DRAFT_MSG.length);
  const inputDisplay = tapElement === "type-field" ? frame < typingStart ? "" : DRAFT_MSG.slice(0, visibleLen) : tapElement === "send-button" ? DRAFT_MSG : "";
  const sendAfter = tapDelay + 22;
  const sentReveal = (0,esm.interpolate)(
    frame,
  ...
  const inputBarText = tapElement === "send-button" && sentReveal > 0.42 ? "" : inputDisplay;
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", height: "100%", position: "relative" }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: {
      backgroundColor: WA_DARK,
      padding: "10px 12px",
      display: "flex",
      ...
      /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { color: "#fff", fontSize: 18 }, children: "\u2190" }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)(Avatar, { initials: "M", size: 36, bg: "#e91e63" }),
      /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { flex: 1 }, children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { color: "#fff", fontSize: 15, fontWeight: "bold", fontFamily: "Segoe UI, Arial, sans-serif" }, children: "Mama" }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { color: "rgba(255,255,255,0.75)", fontSize: 11, fontFamily: "Segoe UI, Arial, sans-serif" }, children: "online" })
      ] }),
      /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", gap: 16, color: "#fff", fontSize: 18 }, children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { children: "\u{1F4DE}" }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { children: "\u{1F4F9}" })
      ] })
    ] }),
    /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { flex: 1, backgroundColor: WA_LIGHT_BG, padding: "12px 10px", display: "flex", flexDirection: "column", gap: 8, overflowY: "hidden" }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: {
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontSize: 13, fontFamily: "Segoe UI, Arial, sans-serif", color: "#111" }, children: "Hoe gaat het? \u{1F60A}" }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: 10, color: "#aaa", textAlign: "right", fontFamily: "Segoe UI, Arial, sans-serif" }, children: "09:10" })
      ] }),
      /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: {
        alignSelf: "flex-end",
        backgroundColor: WA_SENT,
        borderRadius: "10px 0 10px 10px",
        padding: "8px 12px",
        maxWidth: "75%",
        boxShadow: "0 1px 2px rgba(0,0,0,0.15)"
      }, children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontSize: 13, fontFamily: "Segoe UI, Arial, sans-serif", color: "#111" }, children: "Goed hoor, en met jou?" }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: 10, color: "#aaa", textAlign: "right", fontFamily: "Segoe UI, Arial, sans-serif" }, children: "09:14 \u2713\u2713" })
      ] }),
      showNewBubble && /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: {
        alignSelf: "flex-end",
        backgroundColor: WA_SENT,
        borderRadius: "10px 0 10px 10px",
        padding: "8px 12px",
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontSize: 13, fontFamily: "Segoe UI, Arial, sans-serif", color: "#111" }, children: DRAFT_MSG }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: 10, color: "#34B7F1", textAlign: "right", fontFamily: "Segoe UI, Arial, sans-serif" }, children: sentReveal > 0.85 ? "09:18 \u2713\u2713" : "09:18" })
      ] })
    ] }),
    showAttachmentMenu && /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
      position: "absolute",
      bottom: 52,
      left: 8,
      backgroundColor: "#fff",
      ...
      padding: "10px 0",
      minWidth: 150
    }, children: ["\u{1F4F7}  Camera", "\u{1F5BC}\uFE0F  Galerij", "\u{1F4C4}  Document"].map((item) => /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
      padding: "10px 20px",
      fontSize: 14,
      fontFamily: "Segoe UI, Arial, sans-serif",
      color: "#333"
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: {
      ...
      /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: {
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontSize: 16 }, children: "\u{1F60A}" }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: {
          fontSize: 13,
          color: inputBarText ? "#111" : "#aaa",
          fontFamily: "Segoe UI, Arial, sans-serif",
          flex: 1
        }, children: inputBarText || "Bericht" }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontSize: 16 }, children: "\u{1F4CE}" }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontSize: 16 }, children: "\u{1F4F7}" })
      ] }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
        width: 44,
        height: 44,
...
const CallingScreen = () => {
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: {
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { color: "rgba(255,255,255,0.75)", fontSize: 14, fontFamily: "Segoe UI, Arial, sans-serif" }, children: "WhatsApp gesprek..." }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { transform: `scale(${pulse})` }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Avatar, { initials: "M", size: 80, bg: "#e91e63" }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { color: "#fff", fontSize: 22, fontWeight: "bold", fontFamily: "Segoe UI, Arial, sans-serif" }, children: "Mama" }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { color: "rgba(255,255,255,0.7)", fontSize: 13, fontFamily: "Segoe UI, Arial, sans-serif" }, children: "bellen..." }),
    /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", gap: 40, marginTop: 20 }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
        width: 58,
        height: 58,
        borderRadius: "50%",
...
const PhoneMockup = ({ phoneScreen }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  const appear = (0,esm.spring)({ frame, fps, config: { damping: 14, mass: 0.7 }, from: 0.92, to: 1 });
  const opacity = (0,esm.interpolate)(frame, [5, 25], [0, 1], { extrapolateRight: "clamp" });
  const PHONE_W = 280;
  const PHONE_H = 560;
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: {
    opacity,
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
      ...
      /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { position: "absolute", inset: 0, paddingTop: 22, overflow: "hidden" }, children: [
        phoneScreen.type === "chat-list" && /* @__PURE__ */ (0,jsx_runtime.jsx)(ChatListScreen, {}),
        phoneScreen.type === "chat" && /* @__PURE__ */ (0,jsx_runtime.jsx)(
          ChatScreen,
          {
        ...
        phoneScreen.type === "attachment-menu" && /* @__PURE__ */ (0,jsx_runtime.jsx)(
          ChatScreen,
          {
        ...
        phoneScreen.type === "calling" && /* @__PURE__ */ (0,jsx_runtime.jsx)(CallingScreen, {})
      ] }),
      phoneScreen.tapElement && /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "absolute", inset: 0, zIndex: 20 }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
        TapIndicator,
        {
          tapElement: phoneScreen.tapElement,
...
const TextSlide = ({
  ...
  const frame = (0,esm.useCurrentFrame)();
  const fadeIn = (0,esm.interpolate)(frame, [0, 12], [0, 1], { extrapolateRight: "clamp" });
  const titleX = (0,esm.interpolate)(frame, [0, 15], [-60, 0], { extrapolateRight: "clamp" });
  const screenshotScale = (0,esm.interpolate)(frame, [0, 20], [0.95, 1], { extrapolateRight: "clamp" });
  const screenshotOpacity = (0,esm.interpolate)(frame, [5, 25], [0, 1], { extrapolateRight: "clamp" });
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: "#F5EEE6" }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      esm.Img,
      {
        src: (0,esm.staticFile)("heart-logo.png"),
        style: {
          position: "absolute",
          bottom: 36,
          right: 52,
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsxs)(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ (0,jsx_runtime.jsxs)(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { display: "flex", flexDirection: "column", gap: 28 }, children: slide.points.map((point, i) => {
                  const pointOpacity = (0,esm.interpolate)(
                    frame,
                    [12 + i * POINT_DELAY_FRAMES, 12 + i * POINT_DELAY_FRAMES + 12],
                    [0, 1],
                    { extrapolateRight: "clamp" }
                  );
                  const pointX = (0,esm.interpolate)(
                    frame,
                    [12 + i * POINT_DELAY_FRAMES, 12 + i * POINT_DELAY_FRAMES + 12],
                    [-50, 0],
                    { extrapolateRight: "clamp" }
          ...
          hasScreenshot && /* @__PURE__ */ (0,jsx_runtime.jsx)(
            "div",
            {
              style: {
                flex: "0 0 48%",
              ...
              children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
                    esm.Img,
                    {
                      src: (0,esm.staticFile)(`screenshots/${slide.screenshot}`),
                      style: {
                        width: "100%",
                        height: "100%",
                        objectFit: "contain",
          ...
          hasPhone && slide.phoneScreen && /* @__PURE__ */ (0,jsx_runtime.jsx)(
            "div",
            {
              style: {
                flex: "0 0 48%",
              ...
              children: /* @__PURE__ */ (0,jsx_runtime.jsx)(PhoneMockup, { phoneScreen: slide.phoneScreen })
            }
          )
        ]
      }
...
const INTRO_SEC = 3;
const OUTRO_SEC = 5;
const calculateDuration = (script, fps = 30) => {
...
const getSlideOffsets = (script, fps = 30) => {
  const introDuration = INTRO_SEC * fps;
  const offsets = [];
...
const getOutroOffset = (script, fps = 30) => {
...
const SeniorEaseVideo_INTRO_SEC = 3;
const SeniorEaseVideo_OUTRO_SEC = 5;
const SeniorEaseVideo = ({ script }) => {
  const { fps } = (0,esm.useVideoConfig)();
  const introDuration = SeniorEaseVideo_INTRO_SEC * fps;
  const outroDuration = SeniorEaseVideo_OUTRO_SEC * fps;
  const slideOffsets = getSlideOffsets(script, fps);
  const outroOffset = getOutroOffset(script, fps);
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: "#F5EEE6" }, children: [
    script.audioFile && /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Audio, { src: (0,esm.staticFile)(script.audioFile) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 0, durationInFrames: introDuration, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Intro, { title: script.videoTitle }) }),
    script.slides.map((slide, i) => {
      const slideDuration = Math.round(slide.durationInSeconds * fps);
      return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: slideOffsets[i], durationInFrames: slideDuration, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
        TextSlide,
        {
          slide,
          slideNumber: i + 1,
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: outroOffset, durationInFrames: outroDuration, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Outro, {}) })
  ] });
};

;// ./src/scripts/whatsapp-intro.ts

const whatsappIntroScript = {
  ...
  slides: [
    ...
    },
    {
      ...
      points: [
        ...
        "\u{1F4F7} Foto's delen",
        "\u{1F4DE} Bellen en videobellen",
...
;// ./src/scripts/whatsapp-berichten.ts

const whatsappBerichtenScript = {
  ...
  slides: [
    ...
    },
    {
      ...
      points: [
        ...
        "Twee grijze vinkjes = bij de ander afgeleverd \xB7 Twee blauwe vinkjes = gelezen"
      ],
      durationInSeconds: 10,
...
;// ./src/scripts/whatsapp-foto.ts

const whatsappFotoScript = {
  ...
  slides: [
    ...
    },
    {
      title: "Stap 3 & 4",
      points: [
        "Tik op het paperclip-icoontje (\u{1F4CE})",
...
;// ./src/scripts/whatsapp-bellen.ts

const whatsappBellenScript = {
  ...
  slides: [
    ...
    },
    {
      ...
      points: [
        "\u{1F4DE} Tik op het telefoon-icoontje voor een spraakgesprek",
        "\u{1F4F9} Tik op het camera-icoontje voor videobellen",
    ...
    },
    {
      ...
      points: [
        ...
        "Tik op de rode knop (\u{1F4F5}) om op te hangen"
      ],
      durationInSeconds: 6,
...
;// ./src/scripts/whatsapp-veiligheid.ts

const whatsappVeiligheidScript = {
  videoTitle: "Veilig WhatsApp gebruiken",
  slides: [
    {
      title: "Veilig WhatsApp gebruiken",
      points: [
        "WhatsApp is veilig, maar pas op voor oplichters",
        "We leren u hoe u uzelf beschermt",
        "Simpele regels die u altijd kunt onthouden"
      ],
      durationInSeconds: 6
    },
    {
      title: "Regel 1: Ken de afzender",
      points: [
        "Controleer altijd wie u een bericht stuurt",
        "Onbekend nummer? Wees extra voorzichtig",
        "Uw bank of overheid stuurt nooit via WhatsApp"
      ],
      durationInSeconds: 7
    },
    {
      title: "Regel 2: Stuur nooit geld of gegevens",
      points: [
        "Stuur nooit geld naar onbekenden",
        "Deel nooit uw wachtwoord of pincode",
        "Deel nooit uw BSN of bankgegevens",
        "Twijfelt u? Doe het dan NIET"
      ],
      durationInSeconds: 7
    },
    {
      title: "Regel 3: Tik niet op verdachte links",
      points: [
        "Een link in een bericht kan gevaarlijk zijn",
        "Verwacht u de link niet? Tik er dan niet op",
        "Vraag bij twijfel een familielid om hulp"
      ],
      durationInSeconds: 7
    },
    {
      title: "Wat te doen bij twijfel?",
      points: [
        "Bel de persoon op het bekende nummer",
        "Vraag familie of een vriend om mee te kijken",
        "Bezoek seniorease.nl voor meer veiligheidstips"
      ],
      durationInSeconds: 6
    }
  ]
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "seniorease-video-generator:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkseniorease_video_generator"] = self["webpackChunkseniorease_video_generator"] || [];
